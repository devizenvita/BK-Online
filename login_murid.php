					...
					<div class="row justify-content-center generic-height align-items-center">
						<div class="col-lg-8">
							<div class="banner-content text-center">
								<br />
								<h1 class="text-white text-uppercase">HALAMAN LOGIN MURID</h1>
							</div>
						</div>
					</div>
				</div>
			...
			<section class="featured-area">
				...
				<div class="row">
					<div class="col-lg-8 col-md-8">
						<h3 class="mb-30">Silakan Log In</h3>
						<form action="proseslogin_murid.php" method="post">
							<div class="mt-10">
								<input type="text" name="nis" placeholder="Nomor Induk Siswa" onfocus="this.placeholder = ''" onblur="this.placeholder = 'nip'" required class="single-input">
							</div>
						...
						<button class="genric-btn primary circle arrow" style="float:right">Masuk<span class="lnr lnr-arrow-right"></span></button>

					...
					<div class="row justify-content-center generic-height align-items-center">
						<div class="col-lg-8">
							<div class="banner-content text-center">
								<br />
								<h1 class="text-white text-uppercase">HASIL KONSELING MURID</h1>
							</div>
						</div>
					</div>
				</div>
			...
			<section class="featured-area">
				<div class="container">
					...
					<div class="section-top-border">
						<h3 align="center" class="mb-30">Bimbingan Konseling Anda</h3>
						<?php
								...
								<?php
									...
									?>
										<tr>
											...
											<td><a class="genric-btn primary circle" href='print_hasilkonseling.php?id_daftar=<?php echo $buff['id_daftar'];?>'>Unduh</a></td>

					...
					<div class="row justify-content-center height align-items-center">
						<div class="col-lg-8">
							<div class="banner-content text-center">
								<h1 class="text-white text-uppercase">Atur Jadwal Ketersediaan Konseling</h1>
							</div>
						</div>
					</div>
				</div>
			...
			<section class="featured-area">
				...
				<div class="row">
					<div class="col-lg-8 col-md-8" >
						<h3 class="mb-30">Isi Jadwal Ketersediaan Konseling Anda</h3>
						<form action="prosesaturjadwal.php" method="post">
							<div class="mt-10">
								<input type="text" name="nama" placeholder="Nama Anda" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nama'" required class="single-input">
							</div>
							<div class="mt-10">
								<input type="text" name="hari" placeholder="Hari" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Hari'" required class="single-input">
							</div>
							<div class="mt-10">
							...
							<div class="mt-10">
								<input type="text" name="sesi" placeholder="Sesi" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Sesi'" required class="single-input">
							</div>
							<div class="mt-10">
								<input type="text" name="waktu" placeholder="Waktu" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Waktu'" required class="single-input">
							</div>

							<div class="button-group-area mt-40">
							<button class="genric-btn primary circle" style="float:right">Publish</button>

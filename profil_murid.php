					...
					<div class="row justify-content-center generic-height align-items-center">
						<div class="col-lg-8">
							<div class="banner-content text-center">
								<br />
								<h1 class="text-white text-uppercase">PROFIL MURID</h1>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-8 col-md-8">
						...
						<?php
						    ...
						    include"koneksi.php";
						    $nis=$_SESSION['nis'];
						    $select="Select * from murid where nis='$nis'";
						...
						<table align="center" width="487" border="0">
				            <tr>
				                ...
				                <td width="327">: <?php echo $buff['nama_murid'];?></td>
				            </tr>
				            <tr>
				                <td width="150">NIS</td>
				            ...
				            <tr>
				                ...
				                <td>: <?php echo $buff['nama_walas'];?></td>
				            </tr>
				             <tr>
